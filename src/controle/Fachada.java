...
public class Fachada implements IFachada {
	...
	public Fachada(){
		...
		// regras salvar ordem de serviço
		...
		// regras salvar tarefas com suas açoes
	...
	public String excluir(Entidade entidade) {
		...
		// verificar se hé regras para esta entidade
		...
		if(sb.length() > 0)	//tem mensagem?
			...
			if(dao != null){
				...
				System.out.println("Erro na exclusão no fachada");
			}
		}
